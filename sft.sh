...
ft_type="sft_lora"
training_data_prefix="sft.triviaqa_gsm8k.tools.three_tools_single_step_zeroshot_cot.single_step.acc"
training_data="training_data/${training_data_prefix}.jsonl"

stage="all"
model_output_dir="${results_dir}/Meta-Llama-3-8B-Instruct.${training_data_prefix}"
